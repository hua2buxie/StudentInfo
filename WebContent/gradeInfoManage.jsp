...
<script type="text/javascript">
	...
	function deleteGrade()
	{
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要删掉这"+"<font color='red' size=10px>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("gradeDelete",{delIds:ids},function(result){
					if(result.success)
						{
							$.messager.alert("系统提示","您已成功删除<font color='red' size=10px>"+result.delNums+"</font>条数据!");
							$("#dg").datagrid("reload");
						}
					else
